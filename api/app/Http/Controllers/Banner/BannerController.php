...
class BannerController extends Controller {
     ...
     * @apiSuccess {}    url  'banner链接地址',  (behavior为’1‘或‘3’ 类型为String ,behavior为'2'类型为json {"type":"home","id":1}且type只有四种类型：SPM - 半永久,FFA - 快时尚',home-美发店铺主页,artificer-专家主页,id:对应的下拉单的序号 )
     * 
     * 
     ...
     * @apiParam {}    url  'banner链接地址',  (behavior为’1‘或‘3’ 类型为String ,behavior为'2'类型为json {"type":"home","id":1}且type只有四种类型：SPM - 半永久,FFA - 快时尚',home-美发店铺主页,artificer-专家主页,id:对应的下拉单的序号 )
     * 
     * 
     * @apiSuccessExample Success-Response:
     * 	{
