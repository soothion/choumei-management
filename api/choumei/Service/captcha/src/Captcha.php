...
class Captcha
{
     ...
     */
    public function __construct(Input $input, Filesystem $files, Repository $config, ImageManager $imageManager, Redis $redis, Hasher $hasher, Str $str)
    {
    ...
    protected function generate()
    {
        ...
        $this->redis->setex($this->input['uniqid'], $this->expire,  $this->hasher->make($bag));
